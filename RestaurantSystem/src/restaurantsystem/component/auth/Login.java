...
public class Login extends javax.swing.JFrame {
    ...
    private void loginButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginButtonActionPerformed
        if (userNameField.getText().equalsIgnoreCase("aymen")&&passwordField.getText().equalsIgnoreCase("qazi")) {
            ...
            JOptionPane.showMessageDialog(this, userNameField.getText() + "invalid username or password.");
        }
